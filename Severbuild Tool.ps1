...
[string]$script:constWizardInitialCaption = 'White & Case Server Build Tool'
[int]$script:constWizardWidth = 700
[int]$script:constWizardHeight = 700
[bool]$script:constWizardRightToLeft = $false;
# Initial step number
...
#Default Button Size. Doing this so i dont have to set the same values in a bunch of places later.
[int]$script:constButtonHeight = 23;
[int]$script:constButtonWidth = 75;
[int]$script:constButtonAreaHeight = 46;
...
#region Step Label & Description

[int]$script:constLabelStepDisplayNameLeft = 0;
[int]$script:constLabelStepDisplayNameTop = 200;
[float]$script:constLabelStepDisplayNameFontSize = 16;
[int]$script:constLabelStepDescriptionLeft = 0;
[int]$script:constLabelStepDescriptionTop = 0;

#endregion Step Label & Description

#region mandatory settings

# The outer split container
[System.Windows.Forms.SplitContainer]$script:splitOuter = New-Object System.Windows.Forms.SplitContainer;
$script:splitOuter.Dock = [System.Windows.Forms.DockStyle]::Fill;
$script:splitOuter.IsSplitterFixed = $true;
$script:splitOuter.Orientation = [System.Windows.Forms.Orientation]::Horizontal;
$script:splitOuter.SplitterWidth = 5;
#$script:splitOuter.Height = 100

# The inner split container
[System.Windows.Forms.SplitContainer]$script:splitInner = New-Object System.Windows.Forms.SplitContainer;
$script:splitInner.Dock = [System.Windows.Forms.DockStyle]::Fill;
$script:splitInner.IsSplitterFixed = $False;
$script:splitInner.Orientation = `
[System.Windows.Forms.Orientation]::Horizontal;
$script:splitInner.SplitterWidth = 5;
$script:splitInner.Height = 500
$script:splitOuter.Panel1.Controls.Add($script:splitInner);

# The labels for the curent step name and description
[System.Windows.Forms.Label]$script:lblStepDisplayName = New-Object System.Windows.Forms.Label;
$script:lblStepDisplayName.Left = $script:constLabelStepDisplayNameLeft;
$script:lblStepDisplayName.Top = $script:constLabelStepDisplayNameTop;
[System.Drawing.Font]$private:font = $script:lblStepDisplayName.Font;
$private:font = New-Object System.Drawing.Font($private:font.Name, $script:constLabelStepDisplayNameFontsize, $private:font.Style, $private:font.Unit, $private:font.GdiCharSet, $private:font.GdiVerticalFont);
$script:lblStepDisplayName.Font = $private:font;
[System.Windows.Forms.Label]$script:lblStepDescription = New-Object System.Windows.Forms.Label;
$script:lblStepDescription.Left = $script:constLabelStepDescriptionLeft;
$script:lblStepDescription.Top = $script:constLabelStepDescriptionTop;
$script:splitInner.Panel1.Controls.AddRange(($script:lblStepDisplayName, $script:lblStepDescription));

#region the Next and Back buttons
[System.Windows.Forms.Button]$script:btnNext = New-Object System.Windows.Forms.Button;
$script:btnNext.Anchor = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right -bor [System.Windows.Forms.AnchorStyles]::Top;
$script:btnNext.Text = $script:constButtonNextName;
[System.Windows.Forms.Button]$script:btnBack = New-Object System.Windows.Forms.Button;
$script:btnBack.Anchor = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right -bor [System.Windows.Forms.AnchorStyles]::Top;
...
[System.Windows.Forms.Button]$script:btnFinish = New-Object System.Windows.Forms.Button;
$script:btnFinish.Anchor = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right -bor [System.Windows.Forms.AnchorStyles]::Top;
$script:btnFinish.Text = $script:constButtonFinishName;
[System.Windows.Forms.Button]$script:btnCancel = New-Object System.Windows.Forms.Button;
$script:btnCancel.Anchor = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right -bor [System.Windows.Forms.AnchorStyles]::Top;
...
[System.Windows.Forms.Form]$script:frmWizard = New-Object System.Windows.Forms.Form;
$script:frmWizard.Controls.Add($script:splitOuter);
# left-to-right and right-to-left
if ($script:constWizardRigthToLeft)
{
	$script:frmWizard.RightToLeft = [System.Windows.Forms.RightToLeft]::Yes;
	$script:frmWizard.RightToLeftLayout = $true;
}
else
{
	$script:frmWizard.RightToLeft = [System.Windows.Forms.RightToLeft]::No;
